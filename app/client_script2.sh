...
ss-execute --parameters="mapper:multiplicity=$INPUT_SIZE","mapper:product_url='$INPUT_LIST'","mapper:cloudservice=eo-cesnet-cz1","reducer:cloudservice=eo-cesnet-cz1","reducer:nuvla_token='a $equal b'" --keep-running="always" EO_Sentinel_1/procSAR
